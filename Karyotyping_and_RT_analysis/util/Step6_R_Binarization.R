...
save(binned.MAP.HMM.2,file=paste0(out_dir,"/",somy,"/Rdata/",name,"_",ksize,"k_100S_MAP_2HMM_eps0.01_",somy,".Rdata"))

#Plot density
pdf(file=paste0(out_dir,"/",somy,"/plot/",name,"_",ksize,"k_100S_MAP_2HMM_eps0.01_",somy,".pdf"))
...
write.table(binary_out,paste0(out_dir,"/",somy,"/binary/",name,"_",ksize,"k_100S_MAP_2HMM2_eps0.01.binary_",somy,".bedGraph"),sep="\t",col.names=F,row.names=F,quote=F)
